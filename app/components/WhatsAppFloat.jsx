...
export default function WhatsAppFloat() {
  ...
  const phone = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "971567440932";
  const message =
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      {hover && (
        <div className="rounded-full border border-white/10 bg-slate-900 px-4 py-2 text-xs text-white shadow-lg">
          Chat on WhatsApp
        </div>
      )}
